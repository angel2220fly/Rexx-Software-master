...
if Angelhg.nm="1111" & nm=1 & ssdu=1 then
do
kal=3
end

if Angelhgin.nbi="1111" & kal=3 & ssdu=2 & nm=2  then
do
nm=1
Angelhg.nm="1000"
nm=2
...
if Angelhg.nm="1000" & nm=1 & ssdu=1 then
do
kai=3
end

if Angelhgin.nbi="1111" & kai=3 & ssdu=2 & nm=2  then
do
nm=1
Angelhg.nm="1111"
nm=2
