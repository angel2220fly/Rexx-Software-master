...
/*1234 1234 1234 1 6789 1234 1234 10111213*/
/*1234 1234 9101112 13141516 18192021 22232425 */
if df=10 then
do
do i=1 to 4
bl=bl+1
...
if a.1="0" & a.2="1" & a.3="0"  & a.4="0" then
do
if  zxxc=12 then
do
sas=4
...
if couy <> couy1 & couy<>16 & couy1<>16 & c=3 | couy = couy1 & couy<>16 & couy1<>16 & c=3  then
do
sd2=1
c=0
if aqwes=0 then
...
if Angelhgin.nbi="0100" & ssdu=2 & nm=2 & zxs=1 | Angelhgin.nbi="0101" & ssdu=2 & nm=2 & zxs=1 | Angelhgin.nbi="0110" & ssdu=2 & nm=2 & zxs=1  | Angelhgin.nbi="0111" & ssdu=2 & nm=2 & zxs=1 then
do
zxs=0
nm=1
if Angelhg.nm="0100" & nm=1 then
do
nm=2
ljk.nm=Angelhg.nm
nm=1
...
if Angelhgin.nbi="1000" & ssdu=2 & nm=2 | Angelhgin.nbi="1001" & ssdu=2 & nm=2 | Angelhgin.nbi="1010" & ssdu=2 & nm=2 | Angelhgin.nbi="1011" & ssdu=2 & nm=2 | Angelhgin.nbi="1100" & ssdu=2 & nm=2 | Angelhgin.nbi="1101" & ssdu=2 & nm=2   | Angelhgin.nbi="1110"  & ssdu=2 & nm=2  | Angelhgin.nbi="1111"  & ssdu=2 & nm=2 then
do
nm=1
if Angelhg.nm="1000" & nm=1  then
do
nm=2
ljk.nm=Angelhg.nm
nm=1
